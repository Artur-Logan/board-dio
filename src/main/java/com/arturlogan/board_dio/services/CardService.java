...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final Long currentBoardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try {
            ...
            var nextColumn = boardColumnsInfo.stream()
                    ...
                    .findFirst()
                    .orElseThrow(() -> new IllegalStateException("Não existe próxima coluna para o card."));
